          ...
          <div className="flex items-center justify-between border-b border-white/10 pb-4 print:hidden">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handlePrint}
                data-cursor="hover"
                className="flex cursor-pointer items-center gap-2 rounded-xl bg-neon px-4 py-2 text-xs font-bold text-base-950 shadow-glow transition-transform hover:scale-105"
              >
                <Printer size={15} />
